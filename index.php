			...
			<div class="container">
				<div class="row text-center">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="logos">
						<img src="assets/img/header/logo_orange.png" class="hidden-xs hidden-sm img-responsive" alt="logo Orange" width="150" height="150" />

						<h1 class="text-center">FIMUView</h1>

						<img src="assets/img/header/logo_fimu.png" class="hidden-xs hidden-sm img-responsive" alt="logo FIMU" width="150" height="auto" />
					</div>
				</div>
			</div>
 ...
 <section class="container-fluid" >
   ...
   <main>
   		<div class="container-fluid" id="bloc1">
			<div class="container">
				<div class="row text-center">
					...
					<div class="flex-div col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <footer class="text-center">
   	<p id="foot">Crédits : Yohann Thorez / Charlie Moreau / Kevin Villard / Mourad Zouabi / Luc Ratelli</p>
   </footer> 
