  ...
  /*          // Touriste Etranger Nuitée
    ...
    console.log(get_volume_loc(data, "Ville de Belfort"));*/
            ...
            if (nomTable == "age"){
                ...
                value5_2017 = get_volume_age_2017(data, "55-64") + get_volume_age_2017(data, ">65");
    ...
    var FreqGlobal2016 = new d3pie("FreqGlobale2016", {
        ...
        "misc": {
			...
			var valueGlobal2016 = value1_2016 + value2_2016 + value3_2016 + value4_2016 + value5_2016;
			
            $('#FreqGlobale2016').append("<p>Visiteurs : <span class='toto'>"+valueGlobal2016+"</span></p>");
        ...
        "misc": {
			...
			var valueGlobal2017 = value1_2017 + value2_2017 + value3_2017 + value4_2017 + value5_2017;
            $('#FreqGlobale2017').append("<p>Visiteurs : <span class='toto'>"+valueGlobal2017+"</span></p>");
        },
        error: function () {
            console.log('error');
        }
